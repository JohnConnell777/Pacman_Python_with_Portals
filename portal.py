...
class Portal(Block):
    ...
    def __init__(self, screen, x, y, direction, maze, p_type=P_TYPE_1):
        ...
        if p_type == Portal.P_TYPE_1:
            self.image_manager = ImageManager('blueportal.png', sheet=True, pos_offsets=[(0, 0, 32, 32),
                                                                                             (32, 0, 32, 32),
                                                                                             (64, 0, 32, 32),
                                                                                             (0, 32, 32, 32),
                                                                                             (32, 32, 32, 32),
            ...
            self.image_manager = ImageManager('orangeportal.png', sheet=True, pos_offsets=[(0, 0, 32, 32),
                                                                                               (32, 0, 32, 32),
                                                                                               (64, 0, 32, 32),
                                                                                               (0, 32, 32, 32),
                                                                                               (32, 32, 32, 32),
...
class PortalController:
    ...
    def __init__(self, screen, user, maze):
        ...
        self.maze = maze
        self.user = user
        self.sound_manager = SoundManager(sound_files=['portal_launch 2.0.wav', 'portal_launch 2.0.wav'], keys=['open', 'travel'],
