...
class Ghost(Sprite):
    ...
    def __init__(self, screen, maze, target, spawn_info, sound_manager, ghost_file='blinkyred.png'):
        super().__init__()
        self.screen = screen
        self.maze = maze
        ...
        self.norm_images = ImageManager(ghost_file, sheet=True, pos_offsets=[(0, 0, 32, 32), (0, 32, 32, 32)],
                                        ...
                                        animation_delay=250)
        self.blue_images = ImageManager('ghostppellet.png', sheet=True, pos_offsets=[(0, 0, 32, 32), (0, 32, 32, 32)],
                                        resize=(self.maze.block_size, self.maze.block_size),
                                        animation_delay=150)
        self.blue_warnings = ImageManager('ghostppelletwhite.png', sheet=True, pos_offsets=[(0, 0, 32, 32),
                                                                                             (0, 32, 32, 32)],
                                          resize=(self.maze.block_size, self.maze.block_size),
                                          animation_delay=150)
        self.eyes = ImageManager('ghosteyes.png', sheet=True, pos_offsets=[(0, 0, 32, 32), (32, 0, 32, 32),
